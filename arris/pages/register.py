...
def register() -> rx.Component:
    ...
    return rx.box(
        ...
        rx.box(
            ...
            rx.form.root(
                rx.box(
                rx.text("Create an Account", class_name="font-bold text-2xl text-black pb-2"),
                rx.text("Create an account to access the world of", class_name="font-normal text-black text-sm"),
            ...
            rx.box(
                rx.text("Already have an Account?", class_name="font-normal text-black text-sm"),
                rx.text("Sign In", class_name="text-decoration-line: underline font-normal text-[#4193F3] text-sm cursor-pointer", on_click=redirect_to_signin),
